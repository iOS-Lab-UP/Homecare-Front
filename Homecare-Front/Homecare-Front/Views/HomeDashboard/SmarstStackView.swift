...
struct SmartStackView: View {
    ...
    private func generateCards() -> [Card] {
        return [
            ...
            Card(title: "Publicaciones que te pueden interesar: ", value: "Vendo bicicleta", icon: "lightbulb.max", backgroundColor: Color(hex: "#FFC038")), //
            Card(title: "Revisa tú última publicación: ", value: "Clases de guitarra", icon: "newspaper", backgroundColor: Color(hex: "#e85d04")), // Un azul acero
        ]
    }
